...
Version 1.1.0 was compile-checked against local Rust/Oxide assemblies. Final runtime validation should be performed on a current test server before production deployment.
